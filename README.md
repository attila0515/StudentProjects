...
## 1. Fuzzy temperature control in LabVIEW 
### File name: LabVIEW - Fuzzy project
This project presents the design and implementation of a fuzzy logic–based temperature control system developed in the LabVIEW environment.
...
This project deals with axle detection and load estimation of road vehicles using strain gauge measurements installed on a bridge. When several vehicles pass the bridge at the same time in different lanes, the measured signals overlap and become difficult to separate.
